...
<body>
	<%
	if (signUp.getUSER_ID() == null || signUp.getUSER_PW() == null || signUp.getUSER_NAME() == null
			|| signUp.getUSER_EMAIL() == null) {
		...
		//가입성공
			...
			session.setAttribute("USER_ID",signUp.getUSER_ID()); //로그아웃을 하기위한 세션 추가
			PrintWriter script = response.getWriter();
			script.println("<script>");
