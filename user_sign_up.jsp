		...
		<div class="wrapper">
			<div class="join_form">
				...
				<div class="text_center">
					...
					<button type="button" class="id_button" onclick="idCheck()">중복확인</button>
					<br> <br>
				</div>

				<div class="text_center">
					<input type="password" id="new_pw1" name="USER_PW" size="20"
						placeholder="비밀번호" required><br> <br>
				</div>

				<div class="text_center">
					<input type="password" id="new_pw2" name="USER_PW" size="20"
						placeholder="비밀번호 확인" required><br> <br>
				</div>

				<div class="text_center">
					<input type="tel" id="user_tel" name="user_tel" size="20"
						placeholder="전화번호" required><br> <br>
				</div>
				...
				<button type="submit" onClick="" value="회원가입">회원가입</button>
				<%
